...
public class TreeDemoFrame extends JFrame {
    ...
    private JButton minLeftSonButton;
    private JLabel minLeftSonLabel;
    ...
    public TreeDemoFrame() {
        ...
        // добавленная кнопка
        minLeftSonButton.addActionListener(actionEvent -> {
            ...
            int value = Test.getMinLeftSonValue(this.tree);
            // выводим найденное значение в интерфейс
            minLeftSonLabel.setText("" + value);
        });
    }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel8.setBackground(new Color(-37280));
        ...
        minLeftSonLabel = new JLabel();
        minLeftSonLabel.setForeground(new Color(-16711934));
        minLeftSonLabel.setText(".....");
        panel8.add(minLeftSonLabel, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        minLeftSonButton = new JButton();
        minLeftSonButton.setBackground(new Color(-9587528));
        minLeftSonButton.setHideActionText(true);
        minLeftSonButton.setText("наименьший левый потомок");
        panel8.add(minLeftSonButton, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
